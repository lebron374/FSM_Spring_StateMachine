...
@Component
public class DeliveryFailedChoiceGuard implements Guard<OrderStatus, ChangeEvent> {
    ...
    public boolean evaluate(StateContext<OrderStatus, ChangeEvent> context) {
        ...
        logger.info("DeliveryFailedChoiceGuard payLoad {} messageHeader{}", JSON.toJSONString(payLoad), JSON.toJSONString(messageHeader));
