 ...
 */
@Component
public class PayedGuard implements Guard<OrderStatus, ChangeEvent> {
    ...
    public boolean evaluate(StateContext<OrderStatus, ChangeEvent> context) {
        ...
        logger.info("PayedGuard payLoad {} messageHeader{}", JSON.toJSONString(payLoad), JSON.toJSONString(messageHeader));
