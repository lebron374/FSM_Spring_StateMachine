...
@Component
public class PayedSuccessChoiceGuard implements Guard<OrderStatus, ChangeEvent> {
    ...
    public boolean evaluate(StateContext<OrderStatus, ChangeEvent> context) {
        ...
        logger.info("PayedSuccessChoiceGuard payLoad {} messageHeader{}", JSON.toJSONString(payLoad), JSON.toJSONString(messageHeader));
