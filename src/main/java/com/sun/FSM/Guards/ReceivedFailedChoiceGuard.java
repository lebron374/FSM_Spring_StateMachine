...
@Component
public class ReceivedFailedChoiceGuard implements Guard<OrderStatus, ChangeEvent> {
    ...
    public boolean evaluate(StateContext<OrderStatus, ChangeEvent> context) {
        ...
        logger.info("ReceivedFailedChoiceGuard payLoad {} messageHeader{}", JSON.toJSONString(payLoad), JSON.toJSONString(messageHeader));
