...
@Component
public class ReceivedSuccessChoiceGuard implements Guard<OrderStatus, ChangeEvent> {
    ...
    public boolean evaluate(StateContext<OrderStatus, ChangeEvent> context) {
        ...
        logger.info("ReceivedSuccessChoiceGuard payLoad {} messageHeader{}", JSON.toJSONString(payLoad), JSON.toJSONString(messageHeader));
